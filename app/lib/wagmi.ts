...
export const CONTRACT_ADDRESSES = {
  ACCESS_CONTROL: process.env.ACCESS_CONTROL_ADDRESS as `0x${string}`,
  MOCK_ERC20: process.env.MOCK_ERC20_ADDRESS as `0x${string}`,
  ESCROW_CONTRACT: process.env.ESCROW_CONTRACT_ADDRESS as `0x${string}`,
  // Add these when you have them deployed
  AGREEMENT_FACTORY: process.env.AGREEMENT_FACTORY_ADDRESS as `0x${string}`,
};

// Other useful constants
export const MEDIATOR_ADDRESS = process.env.MEDIATOR_ADDRESS as `0x${string}`;
